part of 'figurafiscal_busca.dart';

class _SubGruposBuscaView
    extends WidgetView<FiguraFiscalBusca, _FiguraFiscalBuscaController> {
  const _SubGruposBuscaView(_FiguraFiscalBuscaController state) : super(state);
    ...
    return BaseLayout(
      ...
      appBarActions: [
        ...
        Visibility(
          ...
          child: IconButton(
              onPressed: () {
                widget.figurafiscal.figurafiscal =
                    state.codfigurafiscal![state.selectedIndex];
  ...
  FutureBuilder<List<FiguraFiscal>> clientesWidget() {
    return FutureBuilder<List<FiguraFiscal>>(
              ...
              children: [
                Expanded(
                  ...
                  child: Container(
                    padding: const EdgeInsets.fromLTRB(10, 10, 0, 10),
                    child: Text(
                      widget.data[index].codfigurafiscal.toString(),
                      textAlign: TextAlign.left,
                      style: TextStyle(
                        fontSize: 11,
