part of 'subgrupo_busca.dart';

class _SubGruposBuscaView
    extends WidgetView<SubGruposBusca, _SubGrupoBuscaController> {
  const _SubGruposBuscaView(_SubGrupoBuscaController state) : super(state);
    ...
    return BaseLayout(
      ...
      appBarActions: [
        ...
        Visibility(
          ...
          child: IconButton(
              onPressed: () {
                widget.subgrupo.subgrupo = state.subclas![state.selectedIndex];
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: RoundButton(
                          ...
                          fontsize: 12,
                          onPressed: () {
                            widget.subgrupo.subgrupo =
                                state.subclas![state.selectedIndex];
                            Navigator.pop(context);
                          },
                        ),
                      ),
  ...
  FutureBuilder<List<SubGrupo>> clientesWidget() {
    return FutureBuilder<List<SubGrupo>>(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    padding: const EdgeInsets.fromLTRB(5, 10, 5, 10),
                    child: Text(
                      widget.data[index].subclas.toString(),
                      textAlign: TextAlign.left,
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                        fontSize: 12,
