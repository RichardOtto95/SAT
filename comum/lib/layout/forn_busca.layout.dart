part of 'forn_busca.dart';

class _FornBuscaView extends WidgetView<FornBusca, _FornBuscaController> {
  const _FornBuscaView(_FornBuscaController state) : super(state);
    ...
    return BaseLayout(
      ...
      appBarActions: [
        ...
        Visibility(
          ...
          child: IconButton(
              onPressed: () {
                widget.forn.forn = state.forn![state.selectedIndex];
  ...
  FutureBuilder<List<Forn>> clientesWidget() {
    return FutureBuilder<List<Forn>>(
...
class ListForn extends StatefulWidget {
  const ListForn({
    Key? key,
    required this.data,
    required this.onChanged,
  }) : super(key: key);
  final List<Forn> data;
  final ValueChanged<int> onChanged;

  @override
  State<ListForn> createState() => _ListFornState();
}

class _ListFornState extends State<ListForn> {
  int selectedIndex = 0;
              ...
              children: [
                Expanded(
                  ...
                  child: Container(
                    padding: const EdgeInsets.fromLTRB(10, 10, 0, 10),
                    child: Text(
                      widget.data[index].forn.toString(),
                      textAlign: TextAlign.left,
                      style: TextStyle(
                        fontSize: 11,
