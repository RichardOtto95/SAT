part of 'clientes_busca.dart';

class _ClientesBuscaView
    extends WidgetView<ClientesBusca, _ClientesBuscaController> {
  const _ClientesBuscaView(_ClientesBuscaController state) : super(state);
    ...
    return BaseLayout(
      ...
      appBarActions: [
        ...
        Visibility(
          ...
          child: IconButton(
              onPressed: () {
                widget.cliente.cli = state.clis![state.selectedIndex];
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: RoundButton(
                          ...
                          onPressed: () {
                            widget.cliente.cli =
                                state.clis![state.selectedIndex];
                            Navigator.pop(context);
                          },
                        ),
                      ),
  ...
  FutureBuilder<List<Cli>> clientesWidget() {
    return FutureBuilder<List<Cli>>(
                ...
                Visibility(
                  ...
                  child: Expanded(
                    ...
                    child: Container(
                      padding: const EdgeInsets.fromLTRB(0, 10, 10, 10),
                      child: Text(
                        widget.data[index].nomefantasia ?? "",
                        textAlign: TextAlign.left,
                        style: TextStyle(
                          fontSize: 12,
                          color: index == selectedIndex
